...
api.get('/movements-criteria/:criteria?', ensureAuth, transactionController.getMovementsByValue);
api.put('/movements-update/:id', ensureAuth, transactionController.updateMovement);
